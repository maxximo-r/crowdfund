...
abstract class CrwdfndProtectionBase {
    ...
    protected function init($level_id) {
        ...
        $query = $wpdb->prepare("SELECT * FROM {$wpdb->prefix}crwdfnd_membership_tbl WHERE "
    ...
    public function save() {
        ...
        $wpdb->update($wpdb->prefix . "crwdfnd_membership_tbl", $data, array('id' => $this->owning_level_id));
    }
